 ...
 *
 *  Compilare con Setup-Client.bat (usa il compilatore C# gia' presente
 *  in Windows). Nessuna dipendenza esterna.
 *
 ...
 *    "Gestione remota attivita' pianificate" (la abilita Setup-Server).
...
{
    // ------------------------------------------------------------------
    // Versione del client. Ha una numerazione propria, indipendente da
    // quella della parte server: le due si aggiornano separatamente.
    // ------------------------------------------------------------------
